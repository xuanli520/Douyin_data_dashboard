...
PERMISSIONS = [
    ...
    ("experience:view", "查看体验分析", "experience", "查看体验分析模块"),
    ("dashboard:view", "查看经营看板", "dashboard", "查看经营总览与KPI"),
    ("order:view", "查看订单分析", "order", "查看订单趋势与分析"),
    ("product:view", "查看商品分析", "product", "查看商品漏斗与排行"),
    ("sale:view", "查看销售分析", "sale", "查看销售汇总与渠道"),
    ("after_sale:view", "查看售后分析", "after_sale", "查看退款率与售后原因"),
    ("report:view", "查看报表", "report", "查看报表列表"),
    ("report:generate", "生成报表", "report", "发起报表生成任务"),
    ("report:download", "下载报表", "report", "下载报表文件"),
    ("export:view", "查看导出", "export", "查看导出任务"),
    ...
    ("alert:resolve", "解决预警", "alert", "处理并解决预警"),
    ("alert:ignore", "忽略预警", "alert", "忽略预警项"),
    ("alert:rule", "管理预警规则", "alert", "查看和创建预警规则"),
    ("alert:acknowledge", "确认预警", "alert", "确认预警状态"),
    ("notification:view", "查看通知渠道", "notification", "查看通知渠道列表"),
    ("notification:test", "测试通知渠道", "notification", "发送通知渠道测试"),
    ("system:config", "查看系统配置", "system", "查看系统配置信息"),
    ("system:health", "查看系统健康", "system", "查看系统健康状态"),
    ("system:backup", "创建系统备份", "system", "创建系统备份任务"),
    ("system:cleanup", "执行系统清理", "system", "执行系统清理任务"),
    ("system:user_settings", "管理用户设置", "system", "查看与更新用户设置"),
